class ProxyMachine
  class ClientConnection < EventMachine::Connection
    ...
    def connect_to_server
      ...
      # TODO: just for demonstration, hub_id is the hub identifier
      host, port = @remote
      hub_id = port

      if @remotes[hub_id].nil?
        ...
        @hub_id = port
        @remotes[hub_id] = @server_side
      else
        @server_side = @remotes[hub_id]
        # proxy_incoming_to(@remotes[hub_id], 10240)
      end
    end
